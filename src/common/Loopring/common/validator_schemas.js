...
let basicSchemas = {
  ...
  ABI_METHOD: {
    type: 'enum',
    required: true,
    enum: ['multisendToken','cancelOrder', 'cancelAllOrders', 'cancelOrdersByTokenPairs','approve', 'deposit', 'withdraw', 'transfer', 'balanceOf', 'allowance','symbol','name','decimals','bind','unbind','getBindingAddress'],
  },
  RPC_TAG: {
    type: 'enum',
    required: true,
