...
class AssetsContainer extends React.Component {
  ...
  getTokenBySymbol(symbol,ifFormat){
    let assetToken = this.state.assets.find(item => item.symbol.toLowerCase() === symbol.toLowerCase() ) || {balance:123456*10*1e18, allowance:123456*1e18}
    if(ifFormat){
      if(assetToken){
